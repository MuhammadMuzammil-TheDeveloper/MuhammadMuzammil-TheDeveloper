...
TITLE_PATH = "~"
STACK = [
    "JavaScript (ES6+)", "React.js", "Tailwind CSS", "Bootstrap",
    "Firebase", "Supabase", "PostgreSQL", "MySQL", "WordPress", "Arduino/IoT",
]
ACHIEVEMENTS = [
...
def build():
    ...
    y += 16
    chips_svg, y = build_chips(STACK, y, 0.0, 0.06)
    ...
    y += 16
    list_svg, y = build_list(ACHIEVEMENTS, y, 0.6, 0.15)
